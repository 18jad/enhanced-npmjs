"use strict";
const createDomContent = (data) => {
    const alreadyEnhanced = document.querySelector("[data-enhanced-id='bundlephobia']");
    const placeAfter = document.querySelector(BUNDLEPHOBIA_BEFORE_ELEMENT_SELECTOR);
    ...
    bundlephobiaContent.innerHTML = `
        <div class="pt2 pb1"><span class="b2812e30 b--black-50 fw6">Minfied:</span> <span class="b2812e30 b--black-50 fw5">${convertBytes(data.size, "mb")} MB <span class="c84e15be fw6">(${convertBytes(data.size, "kb")} Kbs)</span></span></div>
        <div class="pt1 pb3"><span class="b2812e30 b--black-50 fw6">Gzipped:</span> <span class="b2812e30 b--black-50 fw5">${convertBytes(data.gzip, "mb")} MB <span class="c84e15be fw6">(${convertBytes(data.gzip, "kb")} Kbs)</span></span></div>
    `;
    ...
    placeAfter === null || placeAfter === void 0 ? void 0 : placeAfter.after(bundlephobiaContainer);
};
